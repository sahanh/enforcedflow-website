...
- A Zapier account with access to:
  ...
  - Email by Zapier
- An EnforcedFlow account ([sign up here](https://app.enforcedflow.com/register))
...
<MultiColumn ratio="equal" gap="md">
  <div slot="left">
    ...
    **Important:** After running the test, open the review URL and approve the sample task. This creates the sample data you'll need when setting up Zap 2's trigger in the next part of this guide.
