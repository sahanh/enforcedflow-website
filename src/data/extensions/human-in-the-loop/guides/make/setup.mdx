---
title: 'Human in the Loop for Make Automations'
description: 'Add human review and approval steps to your AI-powered Make workflows'
platform: 'make'
...
<MultiColumn ratio="equal" gap="md">
  <div slot="left">
    ...
    3. Enter your EnforcedFlow API Key ([Register to get your free API key](https://app.enforcedflow.com))
    4. Click **Save**
